...
class VehicleController:
    ...
    def pid_longitudinal_control(self, desired_speed, current_speed, dt):
        """
    ...
    def stanley_lateral_control(self, current_position: carla.Location, current_yaw: float, next_waypoint: carla.Waypoint, current_speed: float):
        """
        ...
        steering_angle = yaw_error + np.arctan2(self.Kp_lateral * cross_track_error, 1)
    ...
    def control(self, desired_speed, current_speed, current_position, current_yaw, next_waypoint, dt):
        ...
        """
        throttle_brake_control = self.pid_longitudinal_control(desired_speed, current_speed, dt)
        steering_angle_control = self.stanley_lateral_control(current_position, current_yaw, next_waypoint, current_speed)
